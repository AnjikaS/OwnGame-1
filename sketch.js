...
function preload(){
  ...
  loadImage("MC Images/CharacterPunch1.png", "MC Images/CharacterPunch2.png", "MC Images/CharacterPunch3.png", "MC Images/CharacterPunch4.png");
  loadImage("MC Images/CharacterPunch5.png")
...
function Quiz(){
  ...
  Answer1.mousePressed(function(){
    ...
    if(Answer[0]=== CorrectAnswer){
      text("That's correct!",300, windowHeight/2+100)
      score+= 80;
    }
    else{
      text("That's wrong!",300, windowHeight/2+100)
      score-=20;
    }
  })
  ...
  //switch check... if correct or not display;
}
